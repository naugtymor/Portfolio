            ...
            <div className={style.contactDescription}>
                <div className={style.contacts}>
                    ...
                    <div className={style.contactContainer}>
                        ...
                        <div className={style.text}>Republic of Belarus, Minsk, st. Makaenka 12B</div>
                    </div>
                    <div className={style.contactContainer}>
                        <div className={style.logo}></div>
                        <div className={style.text}>+375(44)5316892</div>
                    </div>
                    <div className={style.contactContainer}>
                        <div className={style.logo}></div>
                        <div className={style.text}>znaknikita.it@gmail.com</div>
                    </div>
                </div>
            </div>
